  ...
  render() {
    return (
      <section className="Terms">
        ...
        <section className="termsText">
          <h2>TERMS OF USE</h2>
          <p className="date">Last updated July 28, 2020</p>
          ...
          <div className="terms">
            ...
            <p>
              12. Delete the copyright or other proprietary rights notice from
              any Content.
            </p>
            <p>
              13. Attempt to impersonate another user or person or use the
            ...
            <p>
              16. Interfere with, disrupt, or create an undue burden on the Site
            ...
            <p>
              19. Copy or adapt the Site’s software, including but not limited
              to Flash, PHP, HTML, JavaScript, or other code.
            </p>
            <p>
              20. Decipher, decompile, disassemble, or reverse engineer any of
            ...
            <p>
              22. Use a buying agent or purchasing agent to make purchases on
              the Site.
            </p>
            <p>
            ...
            <p>
              24. Use the Site as part of any effort to compete with us or
              otherwise use the Site and/or the Content for any
              revenue-generating endeavor or commercial enterprise.
            </p>
            <p>25. Upload pornographic imagery.</p>
          </div>
          ...
          <div className="terms">
            <p>1) to edit, redact, or otherwise change any Contributions</p>
            <p>
          ...
          <div className="terms">
            <p>
              ...
              device that utilizes the Apple iOS or Android operating systems,
            ...
            <p>
              ...
              for the mobile application, and to the maximum extent permitted by
          ...
          <p>
            ...
            available at the AAA website: <a href="www.adr.org">www.adr.org</a>.
            ...
            arbitration will take place in Queens, New York. Except as otherwise
          ...
          <p>
            ...
            state and federal courts located in Queens, New York, and the
            ...
            Sale of Goods and the the Uniform Computer Information Transaction
